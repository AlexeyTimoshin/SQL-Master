...
В стандартном SQL нельзя строить графики
...
Число строк таблицы указанной во FROM включая значения NULL  
...
Получится пустая таблица (NULL не равен ничему и даже самому себе, поэтому не будет соответсвий в таблице)
